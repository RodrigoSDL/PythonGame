...
class Score:
    def __init__(self, window: Surface):
        self.window = window  # CHAMA PARA SI A FUNÇÃO DE ABRIR O TERMINAL DO JOGO (JANELA OU window)
        self.surf = pygame.image.load(
            './asset/Scorebg.png').convert_alpha()  # CHAMA SOBRE A JANELA UMA IMAGEM
        self.rect = self.surf.get_rect(left=0, top=0)  # ESTABELECE COMEÇO DA MARCAÇÃO DO RETANGULO

        pass

    def save(self, game_mode: str, player_score: list[int]):
        pygame.mixer_music.load('./asset/Score.wav')  # CHAMA DA PASTA ASSET O ARQUIVO DE AUDIO INICIAL
        ...
        while True:
            ...
            self.score_text(20, text, COLOR_WHITE, SCORE_POS['Enter Name'])
